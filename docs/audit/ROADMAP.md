...
Этапы 0–3 закрыты. Текущий этап: **4 — Frontend session**. Актуальные результаты реализации фиксируются в CHECK.md; исторический аудит сохраняется как исходная точка.
...
| ---- | --------------------------------------- | --------- | ---------- | -------- |
| 0    | Воспроизводимые проверки                | M         | —          | План     |
| 1    | Авторизация чата                        | M         | 0          | Не начат |
| 2    | JWT lifecycle                           | L         | 1          | Не начат |
| 3    | Валидация и ограничения входящих данных | M         | 2          | Не начат |
| 4    | Единый frontend session lifecycle       | L         | 2–3        | Не начат |
| 5    | Контракты и API слой                    | M         | 4          | Не начат |
| 6    | State management                        | M         | 5          | Не начат |
| 7    | FSD структура и границы импортов        | L         | 5–6        | Не начат |
| 8    | Календарь и recurring events            | L         | 7          | Не начат |
