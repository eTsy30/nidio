...
| 14   | Итоговая регрессия и release readiness  | L         | 0–13       | Закрыт   |
...
Закрыт 2026-09-10. Актуальные результаты и ограничения: [RELEASE](RELEASE.md), сводный статус всех этапов: [CHECK](CHECK.md).
