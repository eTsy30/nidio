...
export function PushSettings() {
  ...
  const descriptions: Record<Status, string> = {
    ...
    enabled: "Уведомления чата и календаря включены на этом устройстве.",
    disabled:
      "Получайте сообщения чата, напоминания календаря и уведомления об изменении общих событий.",
  };
