...
export function PushSettings() {
  ...
  const descriptions: Record<Status, string> = {
    ...
    enabled: "Уведомления чата включены на этом устройстве.",
    disabled: "Получайте имя и текст нового сообщения, когда вы не читаете чат.",
  };

  return (
    <div className="space-y-3 p-4">
      <p className="text-sm font-medium">Уведомления чата</p>
